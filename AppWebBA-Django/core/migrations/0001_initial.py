# Generated by Django 5.0.14 on 2025-07-09 05:18
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estadosol', models.CharField(choices=[('Pendiente', 'Pendiente'), ('Aceptada', 'Aceptada'), ('Modificada', 'Modificada'), ('Cerrada', 'Cerrada'), ('Anulada', 'Anulada')], max_length=50)),
                ('guia', models.ForeignKey(blank=True, db_column='nrogd', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.guiadespacho')),
                ('nrofac', models.ForeignKey(db_column='nrofac', on_delete=django.db.models.deletion.DO_NOTHING, to='core.factura')),
                ('ruttec', models.ForeignKey(blank=True, db_column='ruttec', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.perfilusuario')),
            ],
            options={
