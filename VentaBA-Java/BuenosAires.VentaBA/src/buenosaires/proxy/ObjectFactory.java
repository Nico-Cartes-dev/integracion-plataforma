 ...
 * generated in the buenosaires.proxy package. 
...
public class ObjectFactory {
    ...
    private final static QName _AutenticarResponseAutenticarResult_QNAME = new QName("http://tempuri.org/", "AutenticarResult");
    ...
    private final static QName _AutenticarPassword_QNAME = new QName("http://tempuri.org/", "password");
    private final static QName _AutenticarUsername_QNAME = new QName("http://tempuri.org/", "username");
    private final static QName _AutenticarTipousu_QNAME = new QName("http://tempuri.org/", "tipousu");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: buenosaires.proxy
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "AutenticarResult", scope = AutenticarResponse.class)
    public JAXBElement<Respuesta> createAutenticarResponseAutenticarResult(Respuesta value) {
        return new JAXBElement<Respuesta>(_AutenticarResponseAutenticarResult_QNAME, Respuesta.class, AutenticarResponse.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "password", scope = Autenticar.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "username", scope = Autenticar.class)
    public JAXBElement<String> createAutenticarUsername(String value) {
        return new JAXBElement<String>(_AutenticarUsername_QNAME, String.class, Autenticar.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "tipousu", scope = Autenticar.class)
    public JAXBElement<String> createAutenticarTipousu(String value) {
        return new JAXBElement<String>(_AutenticarTipousu_QNAME, String.class, Autenticar.class, value);
    }
